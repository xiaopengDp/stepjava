...
public interface UserMapper {
    ...
    @Select("SELECT id,username,openid,is_auth as isAuth,photo,is_run as isRun FROM pe_user WHERE openid = #{openid}")
    public UserDTO getUserByOpenId(@Param("openid")String openid);

    @Insert("Insert into pe_user(openid,is_auth,is_run) value(#{user.openid},0,0)")
